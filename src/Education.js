...
export class Education extends Component {
  ...
  refreshList() {
    authFetch(variables.API_URL + 'education/')
      .then(res => res.json())
  ...
  createClick() {
    if (this.state.DegreeImageFile) {
      ...
      authFetch(variables.API_URL + 'education/', { method: 'POST', body: fd })
        .then(res => res.json())
        .then((result) => {
          this.refreshList();
          const modalEl = document.getElementById('educationModal');
      ...
      authFetch(variables.API_URL + 'education/', { method: 'POST', headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' }, body: JSON.stringify({ Degree: this.state.Degree, Institution: this.state.Institution, YearOfCompletion: this.state.YearOfCompletion }) })
        .then(res => res.json())
        .then((result) => {
          this.refreshList();
          const modalEl = document.getElementById('educationModal');
  ...
  updateClick() {
    if (this.state.DegreeImageFile) {
      ...
      authFetch(variables.API_URL + 'education/', { method: 'PUT', body: fd })
        .then(res => res.json())
        .then((result) => {
          this.refreshList();
          const modalEl = document.getElementById('educationModal');
      ...
      authFetch(variables.API_URL + 'education/', { method: 'PUT', headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' }, body: JSON.stringify({ EducationId: this.state.EducationId, Degree: this.state.Degree, Institution: this.state.Institution, YearOfCompletion: this.state.YearOfCompletion }) })
        .then(res => res.json())
        .then((result) => {
          this.refreshList();
          const modalEl = document.getElementById('educationModal');
  ...
  deleteClick(id) {
    if (window.confirm('Are you sure?')) {
      authFetch(variables.API_URL + 'education/?id=' + id, { method: 'DELETE', headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' } })
        .then(res => res.json())
  ...
  deleteDegreeFile(educationId) {
    ...
    authFetch(variables.API_URL + 'education/' + educationId + '/file/', {
      method: 'DELETE',
  ...
  downloadDegreeFile = async (education) => {
    try {
      const response = await authFetch(variables.API_URL + 'education/' + education.EducationId + '/download/');
