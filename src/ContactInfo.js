...
export class ContactInfo extends Component {
  ...
  refreshList() {
    authFetch(variables.API_URL + 'contactinfo/')
      .then(res => res.json())
  ...
  createClick() {
    authFetch(variables.API_URL + 'contactinfo/', { method: 'POST', headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' }, body: JSON.stringify({ Email: this.state.Email, PhoneNumber: this.state.PhoneNumber, Address: this.state.Address }) })
      .then(res => res.json())
      .then((result) => {
        this.refreshList();
        const modalEl = document.getElementById('contactModal');
  ...
  updateClick() {
    authFetch(variables.API_URL + 'contactinfo/', { method: 'PUT', headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' }, body: JSON.stringify({ ContactId: this.state.ContactId, Email: this.state.Email, PhoneNumber: this.state.PhoneNumber, Address: this.state.Address }) })
      .then(res => res.json())
      .then((result) => {
        this.refreshList();
        const modalEl = document.getElementById('contactModal');
  ...
  deleteClick(id) {
    if (window.confirm('Are you sure?')) {
      authFetch(variables.API_URL + 'contactinfo/?id=' + id, { method: 'DELETE', headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' } })
        .then(res => res.json())
